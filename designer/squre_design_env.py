...
LastEditTime: 2023-07-20 22:40:14
Description: 
...
class TopoDesignEnv(Env):
    metadata = {
        'render_modes': ['matplotlib_realtime', 'matplotlib_record', 'None'],
    }
    ...
    def _render_frame(self):
        ...
        self.surface_ax.set_title('surface')
        self.wavefront_ax.imshow(self.wavefront)
        self.wavefront_ax.set_title('wavefront')
        self.target_wavefront_ax.imshow(self.target_wavefront)
        self.target_wavefront_ax.set_title('target wavefront')
